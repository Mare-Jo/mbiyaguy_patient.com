...
const texts = [
  "Docteur en Technologie de l'Information et de la Communication, spécialité Internet des Objets",
  "Chef du Département d’Informatique à l’Institut Supérieur Pédagogique de la Gombe en sigle ISP-Gombe",
  "Consultant et Formateur à la Direction de services Informatiques DSI à l’Ecole Informatique de Finances",
  "Consultant Project Manager Software Développement"
];
...
function startCounting(entries, observer) {
  entries.forEach(entry => {
    if (entry.isIntersecting) {
      animateValue("years", 0, 11, 2000);
      animateValue("projects", 0, 10, 2000);
